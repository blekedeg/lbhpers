...
class Admin_fields extends Admin_Controller {
	...
	public function create()
	{
		...
		$this->streams->cp->field_form('news', 'blogs', 'new', 'admin/news/fields', null, array(), true, $extra);
	}
	...
	public function edit()
	{
		...
		$this->streams->cp->field_form('news', 'blogs', 'edit', 'admin/news/fields', $assign_id, array(), true, $extra);
	}
}