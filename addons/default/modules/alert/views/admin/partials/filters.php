<fieldset id="filters">
	...
	<?php echo form_open('', '', array('f_module' => $module_details['slug'])) ?>
		<ul>
			<li class="">
        		<label for="f_status"><?php echo lang('alert:status_label') ?></label>
        		<?php echo form_dropdown('f_status', array(0 => lang('global:select-all'), 'draft'=>lang('alert:draft_label'), 'live'=>lang('alert:live_label'))) ?>
    		</li>

			<!-- <li class="">
        		<label for="f_category"><?php echo lang('alert:category_label') ?></label>
