...
var dataList = {
	...
	url: '<?php echo site_url('admin/pengaduan') ?>',
	loadData: function() {
					...
					html += '\
						<tr>\
							...
							<td width="150" nowrap="nowrap">\
								<a href="<?php echo site_url('admin/pengaduan/edit') ?>/' + json.data[i].id + '" class="button">Edit</a>\
								<a href="<?php echo site_url('admin/pengaduan/delete') ?>/' + json.data[i].id + '" class="button" onclick="return confirm(\'Are you sure you want to delete?\')">Delete</a>\
							</td>\
						</tr>\
					';
				}
