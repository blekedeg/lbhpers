...
class Admin_fields extends Admin_Controller {
	...
	public function create()
	{
		...
		$this->streams->cp->field_form('news', 'news', 'new', 'admin/news/fields', null, array(), true, $extra);
	}
	...
	public function edit()
	{
		...
		$this->streams->cp->field_form('news', 'news', 'edit', 'admin/news/fields', $assign_id, array(), true, $extra);
	}
}