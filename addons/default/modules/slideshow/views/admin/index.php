...
var dataList = {
	...
	url: '<?php echo site_url('admin/slideshow') ?>',
	loadData: function() {
				...
				for (var i = 0; i < json.data.length; i++) {
					...
					html += '\
						<tr>\
							...
							<td><a href="' + json.data[i].image + '" class="modal cboxelement"><img src="' + json.data[i].thumb + '" /></a></td>\
							<td>' + status + '</td>\
							...
							<td width="150" nowrap="nowrap">\
								<a href="<?php echo site_url('admin/slideshow/edit') ?>/' + json.data[i].id + '" class="button">Edit</a>\
								<a href="<?php echo site_url('admin/slideshow/delete') ?>/' + json.data[i].id + '" class="button" onclick="return confirm(\'Are you sure you want to delete?\')">Delete</a>\
							</td>\
						</tr>\
					';
				}
	...
	search: function() {
		...
		this.url = '<?php echo site_url('admin/slideshow') ?>';
		this.loadData();
