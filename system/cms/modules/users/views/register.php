<style>
#register ul {list-style-type:none; margin:20px 0 0 0;}
.alert {padding:10px !important; margin:20px 0 0 0;}
...
<ul>
	...
	<li>
		<?php echo form_submit('btnSubmit', lang('user:register_btn'), 'class="btn btn-info"') ?>
	</li>
</ul>
<?php echo form_close() ?>