<style>
fieldset ul {list-style-type:none; margin-left:0px;}
.alert p {margin:10px !important;}
ul li .input {padding:0px !important;}
</style>
...
<div style="padding:0px;">
	...
	<div class="alert alert-error" style="padding:0px;">
	...
	<fieldset id="profile_fields">
		...
		<ul>
			...
			<li>
				<label>Photo</label>
				<div class="input"><?php echo form_upload('profilePhoto') ?></div>
			</li>
		</ul>
	</fieldset>
