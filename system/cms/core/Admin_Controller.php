...
class Admin_Controller extends MY_Controller {
	...
	public function __construct()
	{
		...
		if (is_logged_in())
		{
			...
			$this->template->menu_order = array('lang:cp:nav_content', 'lang:cp:nav_structure', 'lang:cp:nav_data', 'lang:cp:nav_users', 'lang:cp:nav_settings', 'lang:cp:nav_references', 'lang:global:profile');
